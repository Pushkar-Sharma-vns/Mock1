...
const Signup = ({ setAuth }) => {
  ...
  const { name, email, educational_qualification, curr_designation, curr_organisation, domain, skills, experience, password, retype_password } = inputs;
  ...
  const onSubmitForm = async e => {
    e.preventDefault();
    try {
      const body = { name, email, educational_qualification, curr_designation, curr_organisation, domain, skills, experience, password };
  ...
  return (
    <div className="p-3">
      <div className="row pl-3" style={{ "text-align": "center" }}>
        ...
        <div className=" col-7 main" style={{ "box-shadow": "-4px -4px 8px rgba(0, 0, 0, 0.12), 4px 4px 8px rgba(0, 0, 0, 0.12)", "border-radius": "10px" }}>
          <form onSubmit={onSubmitForm}>
            ...
            <div className="pt-3" style={{ "text-align": "center" }} >
              <button style={{ "minWidth": "190px", "color": "white", "padding": "6px" }} id="btn-practice" onClick={() => history.push('/')}>
                Sign Up
              </button>
